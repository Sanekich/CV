...
const strings = {
    en: {
        ...
        project1: "Project 1: Backend development for team web app",
        project2: "Project 2: Fullstack React Store (In progress)",
    ...
    it: {
        ...
        project1: "Progetto 1: Sviluppo backend per app web di gruppo",
        project2: "Progetto 2: Store React full-stack (in corso)",
